...
$sql = "select * from v_aperturas where id_apercierre = ".$_REQUEST['id'];
...
//$pdf->SetLineWidth(5);
$pdf->Cell(0, 0, "AQUEO DE LA APERTURA NRO: ".$resul[0]['id_apercierre']." (".$resul[0]['caja_descripcion'].")", 0, 1, 'C');
...
//DETALLES DE CHEQUES
$sqlchs = "select * from v_cobro_cheques where id_apercierre = ".$resul[0]['id_apercierre']." order by titular,nro_cheque";
